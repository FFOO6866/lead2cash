...
class ExampleService(BaseService):
    ...
    def get_entity(self, entity_id: int) -> Optional[ExampleEntity]:
        ...
        return (
            ...
            .filter(ExampleEntity.id == entity_id, ExampleEntity.is_active.is_(True))
            .first()
        )
    ...
    def get_entities(self, skip: int = 0, limit: int = 100) -> List[ExampleEntity]:
        ...
        return (
            self.db.query(ExampleEntity)
            .filter(ExampleEntity.is_active.is_(True))
            .offset(skip)
            .limit(limit)
            .all()
        )
    ...
    def update_entity(
        self, entity_id: int, entity_data: ExampleEntityUpdate
    ...
    def delete_entity(self, entity_id: int) -> bool:
        ...
        entity.is_active = False  # type: ignore[assignment]
        self.db.commit()
        return True
    ...
    def search_entities(self, query: str) -> List[ExampleEntity]:
        ...
        return (
            ...
            .filter(
                ...
                ExampleEntity.is_active.is_(True),
            )
            .all()
        )
